...
Dans la suite, on refera au chemin dudit dossier par <program_path>
...
* installer Python3, version >= 3.6 (par defaut, prendre la dernier version
    ...
    refera a ce chemin par <python_exe_path>.
...
Dans une console, executer les commandes suivantes (l'une apres l'autre) :
* cd <program_path>
